...
app = FastAPI(
    ...
    version = "1.8",
    description = "A Longchain agent (gemini) with search_movies and get_weather, sorted via Longserver.",
)

@app.get("/")
def root():
  return{"message":"Server is running, visit /agent/playground/ to caht, or /docs for the API."}
